...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'upload.subtitle': 'Ton année 2025 en mouvement',
    'upload.humor': "Strava n'aime pas que vous jouiez avec vos données. On va les libérer.",
    'upload.dropzone': 'Importe ton export Strava',
    'upload.instruction': 'Glisse-dépose ou clique pour sélectionner ton fichier ZIP',
    'upload.fileType': 'Fichier ZIP uniquement • Max 2 Go',
    'upload.privacy': '🔒 100% privé : tout le traitement se fait dans ton navigateur. Tes données ne quittent jamais ton appareil.',
    'upload.loading': 'Analyse de tes exploits...',
    'upload.extracting': 'Extraction des données du ZIP en cours',
    ...
    'tutorial.step2': 'Dans "Télécharger ou supprimer votre compte", clique sur',
    'tutorial.step2Link': 'Demander un export',
    'tutorial.step3': 'Reçois le lien de téléchargement par email (<3 min)',
    'tutorial.step4': 'Télécharge le fichier .zip et importe-le ici',
    ...
    'slide.intro.subtitle': 'Ton année en chiffres',
    'slide.intro.activities': 'Activités',
    'slide.intro.activitiesDesc': 'exploits réalisés',
    'slide.intro.distance': 'Distance',
    'slide.intro.distanceDesc': 'kilomètres parcourus',
    'slide.intro.elevation': 'Dénivelé +',
    'slide.intro.elevationDesc': 'mètres de dénivelé',
    'slide.intro.message1': '2025 n\'était pas une année',
    'slide.intro.message2': 'C\'était une épopée.',
    ...
    'slide.breakdown.title': 'Activités',
    'slide.breakdown.subtitle': 'Répartition par type',
    'slide.breakdown.diversity': 'Diversité',
    ...
    'slide.elevation.equivalentTo': 'Équivalent à',
    'slide.elevation.message': 'Chaque montée est une victoire',
    'slide.elevation.tapToContinue': 'Tap pour continuer',
    'slide.chronosMonth.title': 'Rythme Annuel',
    'slide.chronosMonth.subtitle': 'Ton année mois par mois',
    'slide.chronosMonth.mostActive': 'Ton mois le plus actif',
    'slide.chronosDay.title': 'Rythme Hebdo',
    'slide.chronosDay.subtitle': 'Tes jours préférés',
    ...
    'slide.social.subtitle': 'Ta communauté Strava',
    'slide.social.followers': 'Followers',
    'slide.social.challenges': 'Défis 2025',
    'slide.social.comments': 'Commentaires',
    'slide.social.completedOf': 'Complétés sur',
    'slide.social.publishedOn': 'Publiés sur Strava',
    'slide.social.community': 'Ta communauté Strava grandit et te soutient',
    'slide.consistency.title': 'Régularité',
    'slide.consistency.subtitle': 'Construire l\'habitude',
    'slide.consistency.recordStreak': 'Série Record',
    'slide.consistency.consecutiveDays': 'jours consécutifs',
    'slide.consistency.currentStreak': 'Série Actuelle',
    'slide.consistency.days': 'jours',
    'slide.consistency.activeDays': 'Jours Actifs',
    'slide.consistency.activeDaysOfYear': 'jours actifs sur l\'année',
    ...
    'slide.consistency.keepItUp': 'Continuez sur cette lancée',
    ...
    'slide.records.uploadMore': 'Uploadez plus d\'activités pour voir vos records',
    'slide.records.longestDistance': 'Plus Longue Distance',
    'slide.records.longestDuration': 'Plus Longue Durée',
    'slide.records.fastestActivity': 'Activité la Plus Rapide',
    'slide.records.globalAverageSpeed': 'Vitesse Moyenne Globale',
    'slide.records.averagePerformance': 'Performance moyenne sur toutes tes activités',
    'slide.records.tapToContinue': 'Tap pour continuer',

    'slide.summary.title': 'Ton Année 2025',
    'slide.summary.incredibleYear': 'Année Incroyable!',
    'slide.summary.wrapped': 'Wrapped 2025',
    'slide.summary.totalActivities': 'Activités Totales',
    'slide.summary.trainingTime': 'Temps d\'Entraînement',
    'slide.summary.hours': 'hrs',
    'slide.summary.favoriteActivity': 'Activité Préférée',
    'slide.summary.times': 'fois',
    'slide.summary.restart': 'Recommencer',
    'slide.summary.keepMoving': 'Continuez à bouger. Continuez à vous surpasser.',
    'slide.summary.seeYouIn2026': 'Rendez-vous en 2026!',
    'slide.summary.shareTitle': 'Mon Strava Wrapped 2025',
    'slide.summary.shareText': 'Mon récap Strava 2025',
    'slide.summary.exportError': 'Erreur lors de l\'export de l\'image',

    'slide.intensity.title': 'Zones Cardiaques',
    'slide.intensity.subtitle': 'Distribution de ton intensité',
    'slide.intensity.dominantZone': 'Zone dominante',
    'slide.intensity.spentInZone': 'Passé {percentage}% du temps dans cette zone',
    'slide.intensity.tapToContinue': 'Tap pour continuer',

    'slide.power.title': 'La Puissance',
    'slide.power.subtitle': 'Watts générés en 2025',
    ...
    'slide.power.powerData': 'Données de puissance',
    'slide.power.activitiesWithSensor': 'activités avec capteur',
    'slide.power.electrifying': 'Électrisant',
    'slide.power.tapToContinue': 'Tap pour continuer',

    'slide.gravity.title': 'La Gravité',
    'slide.gravity.subtitle': 'Vous avez défié la descente',
    'slide.gravity.negativeElevation': 'Dénivelé Négatif',
    'slide.gravity.metersOfDescent': 'mètres de descente',
    'slide.gravity.kneesImpacts': 'Vos genoux ont survécu à',
    'slide.gravity.equivalentImpacts': 'impacts équivalents',
    'slide.gravity.jointsDeserveMedal': 'Vos articulations méritent une médaille',
    'slide.gravity.tapToContinue': 'Tap pour continuer',

    'slide.trail.title': 'Facteur Trail',
    'slide.trail.subtitle': 'Vous avez quitté le bitume',
    'slide.trail.ofDistanceOnTrails': 'de votre distance sur les sentiers',
    'slide.trail.badgeUnlocked': 'Badge débloqué',
    'slide.trail.trailMaster': 'Maître des Sentiers',
    'slide.trail.trailExplorer': 'Explorateur de Sentiers',
    'slide.trail.trailCurious': 'Curieux des Sentiers',
    'slide.trail.bornForTrails': 'Vous êtes né(e) pour les sentiers',
    ...
    'slide.calorie.subtitle': 'Calories brûlées en 2025',
    'slide.calorie.kcalBurned': 'kcal brûlées',
    'slide.calorie.onActivities': 'Sur {count} activité{activityWord} ({percentage}% du total)',
    'slide.calorie.activity': '',
    'slide.calorie.activities': 's',
    'slide.calorie.equivalent': 'Équivalent',
    ...
    'slide.moteur.subtitle': 'Tes paramètres de performance',
    'slide.moteur.ftpThreshold': 'Seuil de Puissance (FTP)',
    'slide.moteur.maxHeartRate': 'Fréquence Cardiaque Max',
    'slide.moteur.bpm': 'bpm',
    'slide.moteur.averagePowerInActivity': 'Puissance moyenne en activité',
    'slide.moteur.mostFrequentZones': 'Zones cardiaques les plus fréquentes',
    'slide.moteur.calibratedForPerformance': 'Machine calibrée pour la performance',
    'slide.moteur.tapToContinue': 'Tap pour continuer',

    'slide.emoji.title': 'Humeur en Émojis',
    'slide.emoji.subtitle': 'Vos activités racontées en symboles',
    'slide.emoji.emotionsInMotion': 'Vos émotions en mouvement',
    'slide.emoji.tapToContinue': 'Tap pour continuer',

    'slide.dominance.detectedProfile': 'Profil détecté',
    'slide.dominance.preparingRecap': 'Préparation de ton récap...',

    'slide.socialSlide.title': 'Social Butterfly',
    'slide.socialSlide.subtitle': 'Ton réseau en 2025',
    'slide.socialSlide.messagesSent': 'Messages Envoyés',
    'slide.socialSlide.conversations': 'conversations',
    'slide.socialSlide.clubsJoined': 'Clubs Rejoints',
    'slide.socialSlide.communities': 'communautés',
    'slide.socialSlide.socialIndex': 'Indice Social',
    'slide.socialSlide.superConnected': 'Super connecté',
    'slide.socialSlide.wellIntegrated': 'Bien intégré',
    'slide.socialSlide.networkGrowing': 'Réseau en croissance',
    'slide.socialSlide.connectedToCommunity': 'Connecté à la communauté',
    ...
    'slide.addict.earlyBird': 'Lève-tôt',
    'slide.addict.afternoon': 'Après-midi',
    'slide.addict.evening': 'Soirée',
    'slide.addict.nightOwl': 'Noctambule',
    'slide.addict.favoriteDay': 'Jour Favori',
    'slide.addict.mostActiveDay': 'ton jour le plus actif',
    'slide.addict.confirmedAddict': 'Accro confirmé',
    'slide.addict.veryRegular': 'Très régulier',
    'slide.addict.moderatelyConnected': 'Connecté modéré',
  ...
  en: {
    ...
    'upload.fileType': 'ZIP file only • Max 2 GB',
    'upload.privacy': '🔒 100% private: all processing happens in your browser. Your data never leaves your device.',
